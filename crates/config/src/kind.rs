...
pub const KEYS: &[(&str, Kind)] = &[
    ...
    ("keybind", Kind::List),
    ("sidebar-left", Kind::List),
    ("sidebar-right", Kind::List),
    ("sidebar-collapsed", Kind::List),
    ("sidebar-left-width", Kind::Int),
    ("sidebar-right-width", Kind::Int),
